...
- `ego_annotation/serving/router.py` — typed multi-cluster router. Maps stable
  ...
  endpoint of their committed GPU group (GPU0/1/2/3/4/6). Canonical public lane ports
  are GPU0 `28000`, GPU1 Hands `28001`, GPU2 `28002`, GPU3 `28003`, GPU4 WiLoR
  `28004`, and GPU6 `28006`
...
`execute`, and `stop` subcommands. The planner accepts only GPU5/GPU7 because
GPU4 is the committed WiLoR production group,
...
`/-/healthz`); it never polls and never waits for model lanes. Down endpoints are
