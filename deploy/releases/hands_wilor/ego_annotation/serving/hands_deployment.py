...
class _HandsWiLoRHttpHandlers:
    ...
    @serve.batch(max_batch_size=8, batch_wait_timeout_s=2.0, batch_size_fn=canonical_batch_size_fn)
    ...
    @serve.batch(max_batch_size=16, batch_wait_timeout_s=2.0, batch_size_fn=canonical_batch_size_fn)
