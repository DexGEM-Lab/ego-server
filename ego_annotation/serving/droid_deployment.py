...
def _config_from_env() -> Any:
    return build_droid_model_config(
        ...
        max_result_journal_entries_per_session=int(os.environ.get("EGO_DROID_MAX_RESULT_JOURNAL", "8193")),
        max_buffer_slots=int(os.environ.get("EGO_DROID_MAX_BUFFER_SLOTS", "8192")),
        max_terminal_tombstones=int(os.environ.get("EGO_DROID_MAX_TERMINAL_TOMBSTONES", "128")),
        cpu_offload=os.environ.get("EGO_DROID_CPU_OFFLOAD", "0") == "1",
        max_concurrent_ba=int(os.environ.get("EGO_DROID_MAX_CONCURRENT_BA", "1")),
