...
def expected_infiller_runtime_config(
    *, batch_cap: int = 4, batch_wait_ms: float = 100.0, max_queued_requests: int = 64, wire_format: str = "multipart",
) -> dict[str, object]:
...
def build_infiller_model_config(
    *,
    ...
    return InfillerModelConfig(
        ...
        batch_policy=batch_policy or BatchPolicy(max_batch_size=4, batch_wait_timeout_s=0.1, max_queued_requests=64),
